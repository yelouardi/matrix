...
public class TypeSkillsController {
  @Autowired private TypeSkillsBS typeSkillsBS;

  @Operation(
      summary = "Create Type Skills",
      description = " Create new type skills by title ...",
      tags = {"skills"})
  @RequestMapping(
      value = "/typeskills",
  ...
  @ResponseBody
  public ResponseEntity createTypeSkills(@RequestBody TypeSkillsVO typeSkills) throws TypeSkillException {
  ...
  @Operation(
      summary = "Find types kills by title",
      description = "Type Skills search by %title% format",
      tags = {"typeskills"})
  ...
  public ResponseEntity getTypeInfo(
    ...
    Optional<TypeSkillsVO> findTypeSkillsTitle =
        Optional.ofNullable(typeSkillsBS.findByTypeSkillsTitle(title));
    if (findTypeSkillsTitle.isEmpty()) {
      Optional<List<TypeSkillsVO>> findType =
          Optional.ofNullable(typeSkillsBS.findListTypeSkillsByTitle(title));
  ...
  @Operation(
      summary = "Find types kills by id",
      description = "Type Skills search by %id% format",
      tags = {"typeskills"})
  ...
  @Operation(
      summary = "Find all type skills",
      description = "Find all  type skill",
      tags = {"typeskills"})
